...
(function() {
  ...
  function test(name, spec) {
    testCM(name, function(cm) {
      ...
      var completion = eronelit_editorv3.hint.sql(cm, {tables: spec.tables});
  ...
  test("keywords", {
    value: "SEL",
    cursor: Pos(0, 3),
    list: [{"text":"SELECT","className":"eronelit_editorv3-hint-keyword"}],
    from: Pos(0, 0),
    to: Pos(0, 3)
  });
  ...
  test("from", {
    value: "SELECT * fr",
    cursor: Pos(0, 11),
    list: [{"text":"FROM","className":"eronelit_editorv3-hint-keyword"}],
    from: Pos(0, 9),
    to: Pos(0, 11)
  });
  ...
  test("table", {
    ...
    cursor: Pos(0, 9),
    tables: simpleTables,
    list: [{"text":"xcountries","className":"eronelit_editorv3-hint-table"}],
    from: Pos(0, 7),
    to: Pos(0, 9)
  });
  ...
  test("schema", {
    ...
    cursor: Pos(0, 12),
    tables: schemaTables,
    list: [{"text":"schema.users","className":"eronelit_editorv3-hint-table"},
        {"text":"schema.countries","className":"eronelit_editorv3-hint-table"},
        {"text":"SCHEMA","className":"eronelit_editorv3-hint-keyword"},
        {"text":"SCHEMA_NAME","className":"eronelit_editorv3-hint-keyword"},
        {"text":"SCHEMAS","className":"eronelit_editorv3-hint-keyword"}],
    from: Pos(0, 7),
    to: Pos(0, 12)
  });
  ...
  test("displayText_table", {
    ...
    list: [{text: "mytable", displayText: "mytable | The main table", "className":"eronelit_editorv3-hint-table"}],
    from: Pos(0, 7),
    to: Pos(0, 10)
  });
