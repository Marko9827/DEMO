(function() {
  ...
  function barH(cm) { return byClassName(cm.getWrapperElement(), "eronelit_editorv3-hscrollbar")[0]; }
  function barV(cm) { return byClassName(cm.getWrapperElement(), "eronelit_editorv3-vscrollbar")[0]; }
