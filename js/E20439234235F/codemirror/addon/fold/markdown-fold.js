...
eronelit_editorv3.registerHelper("fold", "markdown", function(cm, start) {
  var maxDepth = 100;

  function isHeader(lineNo) {
    var tokentype = cm.getTokenTypeAt(eronelit_editorv3.Pos(lineNo, 0));
  ...
  return {
    from: eronelit_editorv3.Pos(start.line, firstLine.length),
    to: eronelit_editorv3.Pos(end, cm.getLine(end).length)
  };
});
