...
/* Just enough of eronelit_editorv3 to run runMode under node.js */
...
require.cache[require.resolve("../../lib/eronelit_editorv3")] = require.cache[require.resolve("./runmode.node")];
