...
// "eronelit_editorv3-selectedtext" when the value is not a string.
...
(function(mod) {
  ...
  eronelit_editorv3.defineOption("styleSelectedText", false, function(cm, val, old) {
    var prev = old && old != eronelit_editorv3.Init;
    if (val && !prev) {
      cm.state.markedSelection = [];
      cm.state.markedSelectionStyle = typeof val == "string" ? val : "eronelit_editorv3-selectedtext";
      reset(cm);
  ...
  var cmp = eronelit_editorv3.cmpPos;
