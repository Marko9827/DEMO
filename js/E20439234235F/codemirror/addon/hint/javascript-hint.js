...
(function(mod) {
  ...
  function scriptHint(editor, keywords, getToken, options) {
    ...
    var innerMode = eronelit_editorv3.innerMode(editor.getMode(), token.state);
  ...
  eronelit_editorv3.registerHelper("hint", "javascript", javascriptHint);
  ...
  eronelit_editorv3.registerHelper("hint", "coffeescript", coffeescriptHint);
