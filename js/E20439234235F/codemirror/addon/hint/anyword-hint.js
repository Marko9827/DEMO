...
(function(mod) {
  ...
  eronelit_editorv3.registerHelper("hint", "anyword", function(editor, options) {
    ...
    return {list: list, from: eronelit_editorv3.Pos(cur.line, start), to: eronelit_editorv3.Pos(cur.line, end)};
  });
});
