...
(function() {
  var mode = eronelit_editorv3.getMode({indentUnit: 2}, "javascript");
  ...
  var ts_mode = eronelit_editorv3.getMode({indentUnit: 2}, "application/typescript")
  function TS(name) {
  ...
  var jsonld_mode = eronelit_editorv3.getMode(
    {indentUnit: 2},
