...
eronelit_editorv3.registerHelper("hintWords", "mbox", rfc2822.concat(rfc2822NoEmail));
...
eronelit_editorv3.defineMode("mbox", function() {
  return {
    startState: function() {
      return {
...
eronelit_editorv3.defineMIME("application/mbox", "mbox");
});
