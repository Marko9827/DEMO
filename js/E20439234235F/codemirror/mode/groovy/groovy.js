...
eronelit_editorv3.defineMode("groovy", function(config) {
  function words(str) {
  ...
  return {
    ...
    indent: function(state, textAfter) {
      if (!state.tokenize[state.tokenize.length-1].isBase) return eronelit_editorv3.Pass;
...
eronelit_editorv3.defineMIME("text/x-groovy", "groovy");
