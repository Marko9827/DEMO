...
(function(mod) {
  ...
  eronelit_editorv3.defineMode("stylus", function(config) {
...
/^return/.test(textAfter) ||
  ...
  // github.com/eronelit_editorv3/eronelit_editorv3/blob/master/mode/css/css.js
  ...
  eronelit_editorv3.registerHelper("hintWords", "stylus", hintWords);
  eronelit_editorv3.defineMIME("text/x-styl", "stylus");
});
