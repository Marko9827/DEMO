...
(function() {
  var mode = eronelit_editorv3.getMode({indentUnit: 2}, "text/x-c");
  ...
  var mode_cpp = eronelit_editorv3.getMode({indentUnit: 2}, "text/x-c++src");
  ...
  var mode_scala = eronelit_editorv3.getMode({indentUnit: 2}, "text/x-scala");
