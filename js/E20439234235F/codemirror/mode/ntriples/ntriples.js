...
eronelit_editorv3.defineMode("ntriples", function() {
...
eronelit_editorv3.defineMIME("application/n-triples", "ntriples");

// N-Quads is based on the N-Triples format (so same highlighting works)
// https://www.w3.org/TR/n-quads/
eronelit_editorv3.defineMIME("application/n-quads", "ntriples");

// previously used, though technically incorrect media type for n-triples
eronelit_editorv3.defineMIME("text/n-triples", "ntriples");
