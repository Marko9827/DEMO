...
(function(mod) {
  ...
  var commonBuiltins = ["abs", "all", "any", "bin", "bool", "bytearray", "callable", "chr",
                        ...
                        "Ellipsis", "__debug__"];
  eronelit_editorv3.registerHelper("hintWords", "python", commonKeywords.concat(commonBuiltins));

  function top(state) {
    return state.scopes[state.scopes.length - 1];
  }

  eronelit_editorv3.defineMode("python", function(conf, parserConf) {
    ...
    var external = {
      ...
      indent: function(state, textAfter) {
        if (state.tokenize != tokenBase)
          return state.tokenize.isString ? eronelit_editorv3.Pass : 0;
  ...
  eronelit_editorv3.defineMIME("text/x-python", "python");

  var words = function(str) { return str.split(" "); };

  eronelit_editorv3.defineMIME("text/x-cython", {
    name: "python",
