...
/*
For extra ASP classic objects, initialize eronelit_editorv3 instance with this option:
    isASP: true
...
eronelit_editorv3.defineMode("vbscript", function(conf, parserConf) {
...
eronelit_editorv3.defineMIME("text/vbscript", "vbscript");
