...
(function() {
  var mode = eronelit_editorv3.getMode({tabSize: 4}, 'textile');
  ...
  MT('simpleLink',
      '[link "eronelit_editorv3":http://eronelit_editorv3.net]');

  MT('referenceLink',
      '[link "eronelit_editorv3":code_mirror]',
      'Normal Text.',
      '[link [[code_mirror]]http://eronelit_editorv3.net]');
