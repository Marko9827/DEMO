...
eronelit_editorv3.defineMode("haxe", function(config, parserConfig) {
...
eronelit_editorv3.defineMIME("text/x-haxe", "haxe");

eronelit_editorv3.defineMode("hxml", function () {
...
eronelit_editorv3.defineMIME("text/x-hxml", "hxml");
