...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    define(["../../lib/eronelit_editorv3", "../htmlmixed/htmlmixed"], mod);
  ...
  eronelit_editorv3.defineMode("soy", function(config) {
    var textMode = eronelit_editorv3.getMode(config, "text/plain");
    var modes = {
      html: eronelit_editorv3.getMode(config, {name: "text/html", multilineTagIndentFactor: 2, multilineTagIndentPastTag: false}),
      attributes: textMode,
      text: textMode,
      uri: textMode,
      trusted_resource_uri: textMode,
      css: eronelit_editorv3.getMode(config, "text/css"),
      js: eronelit_editorv3.getMode(config, {name: "text/javascript", statementIndent: 2 * config.indentUnit})
    };
    ...
    return {
      startState: function() {
        return {
          ...
          localStates: [{
            mode: modes.html,
            state: eronelit_editorv3.startState(modes.html)
          }]
        };
      },
        ...
        return {
          ...
          localStates: state.localStates.map(function(localState) {
            return {
              ...
              state: eronelit_editorv3.copyState(localState.mode, localState.state)
            };
          })
        };
      },
            ...
            if (stream.match(/^\/?}/)) {
              ...
              if (stream.current() == "kind" && (match = stream.match(/^="([^"]+)/, false))) {
                ...
                state.localStates.push({
                  mode: mode,
                  state: eronelit_editorv3.startState(mode)
                });
              }
              return "attribute";
      ...
      indent: function(state, textAfter) {
        ...
        if (top == "comment") return eronelit_editorv3.Pass;
  ...
  eronelit_editorv3.registerHelper("hintWords", "soy", indentingTags.concat(
      ["delpackage", "namespace", "alias", "print", "css", "debugger"]));

  eronelit_editorv3.defineMIME("text/x-soy", "soy");
});
