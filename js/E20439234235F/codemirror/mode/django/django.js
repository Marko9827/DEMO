...
(function(mod) {
  ...
  eronelit_editorv3.defineMode("django:inner", function() {
  ...
  eronelit_editorv3.defineMode("django", function(config) {
    var htmlBase = eronelit_editorv3.getMode(config, "text/html");
    var djangoInner = eronelit_editorv3.getMode(config, "django:inner");
    return eronelit_editorv3.overlayMode(htmlBase, djangoInner);
  });

  eronelit_editorv3.defineMIME("text/x-django", "django");
});
