...
(function(mod) {
  ...
  eronelit_editorv3.defineMode("mscgen", function(_, modeConfig) {
  ...
  eronelit_editorv3.defineMIME("text/x-mscgen", "mscgen");
  eronelit_editorv3.defineMIME("text/x-xu", {name: "mscgen", language: "xu"});
  eronelit_editorv3.defineMIME("text/x-msgenny", {name: "mscgen", language: "msgenny"});
