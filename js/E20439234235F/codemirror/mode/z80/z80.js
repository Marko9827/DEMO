...
eronelit_editorv3.defineMode('z80', function(_config, parserConfig) {
...
eronelit_editorv3.defineMIME("text/x-z80", "z80");
eronelit_editorv3.defineMIME("text/x-ez80", { name: "z80", ez80: true });
