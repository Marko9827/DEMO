...
eronelit_editorv3.defineMode("verilog", function(config, parserConfig) {
  ...
  */
  ...
  return {
    ...
    indent: function(state, textAfter) {
      if (state.tokenize != tokenBase && state.tokenize != null) return eronelit_editorv3.Pass;
      if (hooks.indent) {
  ...
  eronelit_editorv3.defineMIME("text/x-verilog", {
    name: "verilog"
  });

  eronelit_editorv3.defineMIME("text/x-systemverilog", {
    name: "verilog"
  });
  ...
  eronelit_editorv3.defineMIME("text/x-tlv", {
    name: "verilog",
        ...
        if (state.tlvCodeActive) {
          ...
          if (style !== undefined) {
            ...
            style = // make this style distinct from the previous one to prevent
                    // eronelit_editorv3 from combining spans
