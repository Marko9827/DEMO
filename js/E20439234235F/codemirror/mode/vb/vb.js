...
eronelit_editorv3.defineMode("vb", function(conf, parserConf) {
    ...
    eronelit_editorv3.registerHelper("hintWords", "vb", openingKeywords.concat(middleKeywords).concat(endKeywords)
...
eronelit_editorv3.defineMIME("text/x-vb", "vb");
