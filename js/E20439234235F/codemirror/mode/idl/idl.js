...
(function(mod) {
  ...
  eronelit_editorv3.registerHelper("hintWords", "idl", builtinArray.concat(keywordArray));
  ...
  eronelit_editorv3.defineMode('idl', function() {
    return {
  ...
  eronelit_editorv3.defineMIME('text/x-idl', 'idl');
});
