...
/**
 * Author: Hans Engel
 * Branched from eronelit_editorv3's Scheme mode (by Koh Zi Han, based on implementation by Koh Zi Chun)
 */
...
eronelit_editorv3.defineMode("clojure", function (options) {
...
eronelit_editorv3.defineMIME("text/x-clojure", "clojure");
eronelit_editorv3.defineMIME("text/x-clojurescript", "clojure");
eronelit_editorv3.defineMIME("application/edn", "clojure");
