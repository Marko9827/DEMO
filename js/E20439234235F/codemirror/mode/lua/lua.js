...
// LUA mode. Ported to eronelit_editorv3 2 from Franciszek Wawrzak's
// eronelit_editorv3 1 mode.
...
eronelit_editorv3.defineMode("lua", function(config, parserConfig) {
...
eronelit_editorv3.defineMIME("text/x-lua", "lua");
