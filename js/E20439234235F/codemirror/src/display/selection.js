...
export function drawSelectionCursor(cm, head, output) {
  ...
  let cursor = output.appendChild(elt("div", "\u00a0", "eronelit_editorv3-cursor"))
  ...
  if (pos.other) {
    ...
    let otherCursor = output.appendChild(elt("div", "\u00a0", "eronelit_editorv3-cursor eronelit_editorv3-secondarycursor"))
