...
export function eronelit_editorv3(place, options) {
  ...
  let input = new eronelit_editorv3.inputStyles[options.inputStyle](this)
...
export default eronelit_editorv3
...
let initHooks = []
eronelit_editorv3.defineInitHook = f => initHooks.push(f)
