...
export default function(eronelit_editorv3) {
  let optionHandlers = eronelit_editorv3.optionHandlers

  let helpers = eronelit_editorv3.helpers = {}
  ...
  eronelit_editorv3.prototype = {
    ...
    addOverlay: methodOp(function(spec, options) {
      let mode = spec.token ? spec : eronelit_editorv3.getMode(this.options, spec)
